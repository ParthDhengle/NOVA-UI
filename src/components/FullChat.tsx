...
/**
 * Nova FullChat with custom titlebar
 */
    ...
    <div className={`flex flex-col h-screen bg-background text-foreground ${className}`}>
      ...
      >
        ...
        <div className="flex items-center gap-2" style={{ WebkitAppRegion: "no-drag" }}>
          ...
          <button onClick={maximize} title="Maximize" className="hover:text-primary">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
              <rect x="1" y="1" width="10" height="10" rx="1" />
            </svg>
          </button>
          <button onClick={close} title="Close" className="hover:text-red-500">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="currentColor">
              <path d="M7 5L5 7M5 5L7 7" stroke="currentColor" strokeWidth="1.5" />
            </svg>
          </button>
        </div>
      </div>
